...
const CodingQuestion = ({ question, adminUser, setisEditable, setVisible }) => {
    ...
    const handleDelete = async (id) => {
        ...
        if (window.confirm("Do you want to delete this question ?") === true) {
            try {
                await axios.delete("https://mecoderbackend.vercel.app/", {
                    data: {
                        _id: id
                    }
                }).then(() => {
